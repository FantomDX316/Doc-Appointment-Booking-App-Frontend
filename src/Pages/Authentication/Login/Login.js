          ...
          <div className={`${styles.loginContent}`}>
            ...
            <div className="midContent col-md-12 col-12 col-sm-12 p-4">
              <form
                ...
                className={`${styles.loginForm} col-md-12 d-flex flex-column mt-4`}
              >
                <div
                  className={`${styles.fieldContainer} col-md-12 col-sm-12 col-12 text-center m-2`}
                >
                  <input
                    type="text"
                    id="email"
                  ...
                  <div className="loginButton">
                    {isLoginLoading ? (
                      <button
                        type="button"
                        disabled={true}
                        className={`${styles.loginButtonEle}`}
                      >
