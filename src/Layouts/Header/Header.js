...
const Header = () => {
  ...
  return (
    <div className={`${styles.header}`}>
      <div
        className={`${styles.headerContent} row align-items-center justify-content-center`}
      >
        <div
          className={`${styles.navLogo} col-md-4 col-sm-4 col-4 d-flex align-items-center justify-content-center`}
        >
          <svg
            onClick={() => {
              navigate("/");
          ...
          <div className={`${styles.navTab} col-md-2`}>
            <div className="dropdown">
              <button
                ...
                data-bs-toggle="dropdown"
                aria-expanded="false"
                style={{ background: "white", border: "0px", color: "black" }}
              >
                Blog
              </button>
              <ul className="dropdown-menu">
